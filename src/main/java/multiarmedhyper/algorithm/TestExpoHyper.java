...
public class TestExpoHyper extends ExpoHyper {
    
    public TestExpoHyper(ParameterReader param, double eta) {
        super(param, eta);
    }
    
    public TestExpoHyper(ParameterReader param) {
        super(param);
    }
    ...
    public String algorithmName() {
        return "TestExpoHyper[" + eta + "," + delta + "]";
    }
}
